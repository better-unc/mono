...
import { UnfoldMoreIcon, Tick02Icon, ArrowUp01Icon, ArrowDown01Icon } from "@hugeicons-pro/core-stroke-standard";
...
function SelectLabel({ className, ...props }: SelectPrimitive.GroupLabel.Props) {
  return <SelectPrimitive.GroupLabel data-slot="select-label" className={cn("text-muted-foreground px-2 py-2 text-xs", className)} {...props} />;
}
...
function SelectSeparator({ className, ...props }: SelectPrimitive.Separator.Props) {
  return <SelectPrimitive.Separator data-slot="select-separator" className={cn("bg-border -mx-1 h-px pointer-events-none", className)} {...props} />;
}
